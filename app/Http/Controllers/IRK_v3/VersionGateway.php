...
class VersionGateway extends Controller
{
    ...
    public function get(Request $request)
    {
        ...
        try {
            $response = $this->helper->Client('toverify_gcp')->request('POST', $this->base . '/version/get', [
                'json' => [
                    'data' => $request->all()
                ]
            ]);
    ...
    {
        try {
            $response = $this->helper->Client('toverify_gcp')->request('POST', $this->base . '/version/post', [
                'json' => [
                    'data' => $request->all()
                ]
            ]);
