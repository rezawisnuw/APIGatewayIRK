...
class IRKPresensiGateway extends Controller
{
    private $resultresp;
	private $dataresp;
	private $messageresp;
    ...
    public function get(Request $request)
    {
        try { 
            ...
            $models = new Credentials ($request,$this->slug);
            $SPExecutor = $models->SPExecutor($getData);
    ...
    public function post(Request $request)
    {
        try {
            ...
            if($decode_signature->result == 'Match'){
                ...
                //Panggil model utk proses dan simpan data ke database
                $models = new Credentials($request, $this->slug);
                $result = $models->SPExecutor($requestData);

                $response = [
                'status' => 'success',
                'message' => 'Data processed and saved successfully',
                'data' => $result, // Jika perlu mengirim kembali data dari service ke gateway
            ];
