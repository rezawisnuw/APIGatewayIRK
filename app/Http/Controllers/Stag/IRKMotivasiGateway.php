            ...
            if($this->userValid($request)->getData()->result == 'Match'){
                ...
                if(!empty($result->data)){
                    ...
                    foreach($result->data as $key=>$value){
                        ...
                        if(!empty($value->picture) && str_contains($value->picture,'Stag/Ceritakita/Motivasi/')){
        ...
        try {
            ...
            if($this->userValid($request)->getData()->result == 'Match'){
                if(!empty($request->photo)){
                    $response = (new self)->client('toverify_gcp')->request('POST', 'stag/motivasi/post', [
                        'multipart'=>[
                            [
                                'name' => 'data',
                    ...
                    if(!empty($result->data)){
                        ...
                        $response = $client->post(
                            'http://'.config('app.URL_GCP_LARAVEL').'stag/motivasi/get',
                            [
                                RequestOptions::JSON => 
                                [
                                    'data' => [
