				...
				try {
					...
					foreach($result as $key=>$value){
						...
						if(isset($value->NIK)){
							...
							$value->ALIAS = !empty($temp->data) ? empty($temp->data[0]->Alias) ? static::EncodeString(new Request(),'Sidomar'.$value->NIK) : $temp->data[0]->Alias : 'Data Corrupt';$value->ALIAS = !empty($temp->data) ? $temp->data[0]->Alias : 'Sidomar'.$value->NIK;
